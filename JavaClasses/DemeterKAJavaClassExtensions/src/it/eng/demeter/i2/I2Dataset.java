...
public class I2Dataset extends DemeterAbstractJavaClassDataSet /*implements it.eng.spagobi.tools.dataset.bo.IJavaClassDataSet*/ {
	...
	private String indicatorParam = "All";

	@Override
	public String getValues(Map profile, Map parameters) {
		try {
			indicatorParam = parameters.get("INDICATOR").toString();
			indicatorParam = indicatorParam.replaceAll("\'","");
		} catch (Exception e) {
			logger.error("No  \"INDICATOR\" finded in parameters! \"All\" value will be used!\n" + e.getMessage(), e.getCause());
			e.printStackTrace();
		}
