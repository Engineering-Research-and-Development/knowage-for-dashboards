...
4. Copy and paste the content below into the docker-compose file. 
	* Note: remember to check and change the **image** tag version with the latest one: 
		* **image: demeterengteam/knowagedb-7.2.0:<mark>v2.3</mark>**
		* **image: demeterengteam/knowage-7.2.0:<mark>idm-v2.3</mark>**
...
services:
   ...
   knowagedb:
      hostname: knowagedb
      image: demeterengteam/knowagedb-7.2.0:v2.3
      networks:
         - hostnet
      ports:
       - "3306:3306"
   ...
   knowage:
      hostname: knowage
      image: demeterengteam/knowage-7.2.0:idm-v2.3
      networks:
         - hostnet
      ports:
         - "8080:8080"
