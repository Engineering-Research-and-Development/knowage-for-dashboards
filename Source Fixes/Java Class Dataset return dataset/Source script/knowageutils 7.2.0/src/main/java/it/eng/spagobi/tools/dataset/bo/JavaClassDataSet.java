...
import it.eng.spagobi.tools.datasource.bo.IDataSource; // Refer to: Fix#001
...
public class JavaClassDataSet extends ConfigurableDataSet {
	...
	public SpagoBiDataSet toSpagoBiDataSet() {
		 ...
		 * JSONObject(); jsonConf.put(JCLASS_NAME, getClassName()); sbd.setConfiguration(jsonConf.toString()); }catch (Exception e){
	...
	public JavaClassDataProxy getDataProxy() {
		...
		if (!(dataProxy instanceof JavaClassDataProxy))
